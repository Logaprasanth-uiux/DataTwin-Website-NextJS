    ...
    <div className="rip-page is-ppo">
      ...
      <section className="section ppo-rec-sec">
        <div className="wrap">
          ...
          <div className="ppo-sec-cta" data-reveal>
            <a href="/get-estimate" className="btn btn-primary">Get an estimate for payouts <svg className="icon stroke" viewBox="0 0 24 24" style={{ width: "16px", height: "16px" }}><use href="#ic-arrow-right" /></svg></a>
            <a href="/darp-framework" className="btn btn-ghost">How Discover works</a>
          </div>
        </div>
      </section>
